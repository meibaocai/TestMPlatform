# Generated by Django 2.0 on 2019-12-12 16:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='image/default.png', upload_to='users/')),
                ('add_time', models.DateField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('b_department', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='manager.DepartmentInfo', verbose_name='所属组织')),
